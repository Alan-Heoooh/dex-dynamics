...
def main(args=None):
    ...
    # ee states
    ee_states_pub = node.create_publisher(StampedFloat32MultiArray, '/ee_states', 10)
    ...
    while rclpy.ok():
        ...
        stamped_ee_state_msg = StampedFloat32MultiArray()
        stamped_ee_state_msg.header.stamp = node.get_clock().now().to_msg()
        ...
        stamped_ee_state_msg.data = ee_state_msg
        ee_states_pub.publish(stamped_ee_state_msg)
