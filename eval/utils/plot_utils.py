...
from utils.cv2_util import findContours


# from crc.utils.flow_viz import *
...
def image_grid(
    ...
    if figsize is None:
        ...
        aspect_ratio = aspect_ratio * images[0].shape[1] / images[0].shape[0]
        width = int(15 * aspect_ratio)
        figsize = (width, 15)
    evaltime('0.5')
